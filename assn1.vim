...
set ruler
set scrolloff=5
set sessionoptions=blank,buffers,curdir,folds,help,options,tabpages,winsize,terminal,resize
set shiftwidth=4
set showcmd
...
wincmd w
argglobal
if bufexists("output/out2.txt") | buffer output/out2.txt | else | edit output/out2.txt | endif
balt output/out1.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
keepjumps 1
normal! 0
lcd ~/csci5451/assignment-1
wincmd w
exe 'vert 1resize ' . ((&columns * 89 + 89) / 179)
exe 'vert 2resize ' . ((&columns * 89 + 89) / 179)
tabnext
edit ~/csci5451/assignment-1/Makefile
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 115 + 89) / 179)
exe 'vert 2resize ' . ((&columns * 63 + 89) / 179)
argglobal
terminal ++curwin ++cols=115 ++rows=41 
let s:term_buf_8 = bufnr()
balt ~/csci5451/assignment-1/Makefile
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
balt ~/csci5451/assignment-1/output/out1.txt
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
